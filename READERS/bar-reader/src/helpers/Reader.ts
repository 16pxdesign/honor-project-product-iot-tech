...
export class Reader {
    ...
    /** init reader and start scanning */
    ...
    /** set listeners for reader device */
    async setListeners(): Promise<boolean> {
        ...
        //Create event if reader stop scanning
    ...
    getCallback(client: any, transaction?: any): Function {
        //TODO: check is active listener.active [deprecated]
    ...
    callback(client: any, data: any, transaction?: any) {
        ...
        this.productService.scanned(c)
            .catch((e) => {
                //TODO: MORE Error handling on fail
