...
class Reader {
    constructor(device) {
        ...
        if (!process.env.KAFKA_HOST)
            console.log('Localhost mode due no env for kafka');
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                try {
                    this.device = DeviceWrapper_1.default.open((error) => {
                        throw error;
                    });
                }
                catch (error) {
    ...
    onStartScan(value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //create listener
            const listener = yield ReaderHandler_1.ReaderHandler.getInstance().setValidatedListener(this.device, 'data', callback, value.client, value.transaction, value.timeout);
            if (!listener)
    ...
    onStopScan(value) {
        //TODO: TEST IT?
        ReaderHandler_1.ReaderHandler.getInstance().deleteListener(this.device, value.client, 'data', value.transaction);
