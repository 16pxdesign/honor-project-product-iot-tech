...
const Device = new DeviceWrapper_1.default();
class Reader {
    constructor(device) {
    ...
    onStartScan(value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //create listener
            const listener = yield ReaderHandler_1.ReaderHandler.getInstance().setValidatedListener(Device, 'data', callback, value.client, value.transaction, value.timeout);
            if (!listener)
    ...
    onStopScan(value) {
        //TODO: TEST IT?
        ReaderHandler_1.ReaderHandler.getInstance().deleteListener(Device, value.client, 'data', value.transaction);
