...
class Reader {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.device.state === 'poweredOn') {
                return new Promise((resolve, reject) => {
                    DeviceWrapper_1.default.startScanning([], true, (error) => {
                        if (error) {
                            reject(error);
                        }
                        else {
                ...
                return new Promise((resolve, reject) => {
                    this.device.on('stateChange', (state) => {
                        if (state === 'poweredOn') {
                            DeviceWrapper_1.default.startScanning([], true, (error) => {
                                if (error) {
                                    reject(error);
    ...
    setListeners() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.device.on('scanStop', () => __awaiter(this, void 0, void 0, function* () {
                this.isScanning = false;
                yield this.init();
            }));
    ...
    onStartScan(value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //create listener
            const listener = yield ReaderHandler_1.ReaderHandler.getInstance().setValidatedListener(DeviceWrapper_1.default, 'discover', callback, value.client, value.transaction, value.timeout);
            if (!listener)
    ...
    onStopScan(value) {
        //TODO: TEST IT?
        ReaderHandler_1.ReaderHandler.getInstance().deleteListener(DeviceWrapper_1.default, value.client, 'discover', value.transaction);
